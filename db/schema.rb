...
ActiveRecord::Schema.define(version: 20150109002802) do
  ...
  add_index "tracks", ["album_id", "song_title"], name: "index_tracks_on_album_id_and_song_title", unique: true, using: :btree
